...
Визуальный дизайн, компоновка и пользовательский поток детально представлены в виде интерактивных мокапов (прототипов). Полная спецификация пользовательского интерфейса содержится в файлах мокапов, расположенных в директории проекта `docs/mockups/`.

#### Основные экраны приложения:

| Экран | Описание | Файл |
|-------|-----------|------|
| **Лендинг** | Главная страница платформы с описанием возможностей и призывом к действию | [`landing.png`](docs/mockups/landing.png) |
| **Регистрация** | Форма создания нового аккаунта в системе | [`reg.png`](docs/mockups/reg.png) |
| **Авторизация** | Страница входа в существующий аккаунт | [`login.png`](docs/mockups/login.png) |
| **Лента мероприятий** | Дашборд с мероприятиями, рекомендациями и поиском | [`events.png`](docs/mockups/events.png) |
| **Создание мероприятия** | Форма для настройки всех параметров нового события | [`create.png`](docs/mockups/create.png) |
| **Страница мероприятия** | Детальная информация о событии с чатом и комментариями | [`eventpage.png`](docs/mockups/eventpage.png) |
| **Чат мероприятия** | Интерфейс общения участников события в реальном времени | [`chat.png`](docs/mockups/chat.png) |
| **Приглашения** | Система управления приглашениями на мероприятия | [`inivte.png`](docs/mockups/inivte.png) |
| **Поиск** | Результаты поиска мероприятий с фильтрацией | [`searched.png`](docs/mockups/searched.png) |
| **Профиль пользователя** | Личный кабинет пользователя с настройками и активностью | [`user.png`](docs/mockups/user.png) |
| **Мой профиль** | Страница редактирования персональных данных | [`me.png`](docs/mockups/me.png) |

**Ссылка на папку с мокапами:** [`docs/mockups/`](docs/mockups/)

---

Теперь в вашем SRS документе будет четкая таблица со ссылками на все мокапы, что сделает документ более практичным и удобным для использования разработчиками и дизайнерами.
